...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("INSERT INTO tbl_hp_pj VALUES('$nis','$nama','$jabatan','$satuan_kerja','$tgl_surat','$no_surat','$it','$merek','$type','$sn','$no_inventory','$keterangan')");
...
?>
<h2>Form Surat BA Peminjaman HP</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=pj_hp&aksi=add" class="form-horizontal" role="form">
