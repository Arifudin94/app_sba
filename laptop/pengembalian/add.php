...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("INSERT INTO tbl_laptop_pb VALUES('$nis','$nama','$jabatan','$satuan_kerja','$tgl_surat','$no_surat','$it','$merek','$type','$sn','$no_inventory','$keterangan')");
		
		if($sql > 0){
			$sql = mysql_query("SELECT * FROM tbl_laptop_pb ORDER BY nis");
		echo '<h2>Data Pengembalian LAPTOP</h2><hr>';
      echo '<div class="row">';
...
?>
<h2>Form Surat BA Pengembalian LAPTOP</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=pb_laptop&aksi=add" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="./admin.php?hlm=master&sub=pb_laptop" class="btn btn-link">Batal</a>
		</div>
	</div>
</form>
<?php
