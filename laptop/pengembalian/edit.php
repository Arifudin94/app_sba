...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("UPDATE tbl_laptop_pb SET nama='$nama', merek='$merek', jabatan='$jabatan', satuan_kerja='$satuan_kerja', tgl_surat='$tgl_surat',
...
?>
<h2>Edit Form Surat BA Pengembalian LAPTOP</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=pb_laptop&aksi=edit" class="form-horizontal" role="form">
