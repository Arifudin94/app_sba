...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("INSERT INTO tbl_headset_pb VALUES('$nis','$nama','$jabatan','$satuan_kerja','$tgl_surat','$no_surat','$it','$merek','$type','$sn','$no_inventory','$keterangan')");
...
?>
<h2>Form Surat BA Pengembalian HEADSET</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=pb_headset&aksi=add" class="form-horizontal" role="form">
