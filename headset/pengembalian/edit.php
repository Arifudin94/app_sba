...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("UPDATE tbl_headset_pb SET nama='$nama', merek='$merek', jabatan='$jabatan', satuan_kerja='$satuan_kerja', tgl_surat='$tgl_surat',
      ...
      echo '<div class="row">';
		...
		echo '<tr class="info" >
				...
				<th>Keterangan</th>
				';
		echo '<th width="85"><a href="./admin.php?hlm=master&sub=pb_headset&aksi=add"><img src="add-file.png" width="20" height="20" /></a></th></tr>';
		...
		$nis = $_REQUEST['nis'];
		$sql = mysql_query("SELECT * FROM tbl_headset_pb WHERE nis='$nis'");
		list($nis,$nama,$jabatan,$satuan_kerja,$tgl_surat,$no_surat,$it,$merek,$type,$sn,$no_inventory,$keterangan) = mysql_fetch_array($sql);
?>
<h2>Edit Form Surat BA Pengembalian HEADSET</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=pb_headset&aksi=edit" class="form-horizontal" role="form">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			...
			<a href="./admin.php?hlm=master&sub=pb_headset" class="btn btn-link">Batal</a>
		</div>
	</div>
</form>
<?php
