...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysql_query("UPDATE tbl_headset_hl SET nama='$nama', merek='$merek', jabatan='$jabatan', satuan_kerja='$satuan_kerja', tgl_surat='$tgl_surat',
...
?>
<h2>Edit Form Surat BA Holder HEADSET</h2>
<hr>
<form method="post" action="admin.php?hlm=master&sub=hl_headset&aksi=edit" class="form-horizontal" role="form">
